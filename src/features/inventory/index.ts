...
export { useProducts, useProductByBarcode, productRefQuery, useCreateProduct, useUpdateProduct, useDeleteProduct, useBulkCreateProducts, useCreateStockEntry } from './react-query';
...
export type { Product, ProductRef, CreateProductDto, UpdateProductDto, StockEntry, CreateStockEntryDto, StockEntryType, ProductDropdown } from './types';
